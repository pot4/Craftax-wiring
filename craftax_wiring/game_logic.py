...
def do_action(rng, state, action, static_params):
    ...
    no_mob = did_attack_mob == False

    # Wire
    is_mining_wire =  jnp.logical_and(state.map[block_position[0], block_position[1]] == BlockType.WIRE.value, no_mob)
    ...
    # Junction
    is_mining_junction =  jnp.logical_and(state.map[block_position[0], block_position[1]] == BlockType.JUNCTION.value, no_mob)
    ...
    # AND
    is_mining_AND =  jnp.logical_and(state.map[block_position[0], block_position[1]] == BlockType.AND.value, no_mob)
    ...
    # OR
    is_mining_OR =  jnp.logical_and(state.map[block_position[0], block_position[1]] == BlockType.OR.value, no_mob)
    ...
    # XOR
    is_mining_XOR =  jnp.logical_and(state.map[block_position[0], block_position[1]] == BlockType.XOR.value, no_mob)
    ...
    # NOT
    is_mining_NOT =  jnp.logical_and(state.map[block_position[0], block_position[1]] == BlockType.NOT.value, no_mob)
    ...
    # Pressure plate
    is_mining_pressure_plate =  jnp.logical_and(state.map[block_position[0], block_position[1]] == BlockType.PRESSURE_PLATE.value, no_mob)
