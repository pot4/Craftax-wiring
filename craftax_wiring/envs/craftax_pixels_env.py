...
class CraftaxWiringPixelsEnvNoAutoReset(EnvironmentNoAutoReset):
    ...
    @property
    def name(self) -> str:
        return "Craftax-Wiring-Pixels-NoAutoReset-v1"
...
class CraftaxWiringPixelsEnv(environment.Environment):
    def __init__(self, static_env_params: StaticEnvParams = None):
        super().__init__()
    ...
    @property
    def name(self) -> str:
        return "Craftax-Wiring-Pixels-v1"
