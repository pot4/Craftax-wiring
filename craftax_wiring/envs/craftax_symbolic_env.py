...
from craftax.craftax_wiring.envs.common import compute_score
from craftax.craftax_wiring.constants import *
from craftax.craftax_wiring.game_logic import craftax_step, is_game_over
from craftax.craftax_wiring.envs.craftax_state import (
    EnvState,
    EnvParams,
    StaticEnvParams,
)
from craftax.craftax_wiring.renderer import render_craftax_symbolic
from craftax.craftax_wiring.world_gen import generate_world
...
class CraftaxWiringSymbolicEnvNoAutoReset(EnvironmentNoAutoReset):
    ...
    @property
    def name(self) -> str:
        return "Craftax-wiring-Symbolic-NoAutoReset-v1"
...
class CraftaxWiringSymbolicEnv(environment.Environment):
    def __init__(self, static_env_params: StaticEnvParams = None):
        super().__init__()
    ...
    @property
    def name(self) -> str:
        return "Craftax-Wiring-Symbolic-v1"
